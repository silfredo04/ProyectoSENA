...
import { crearCursos, obtenerCursos, actualizarEstadoCursos } from '../componentes/funciones/Funciones';
...
export const FormCrearCurso = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const respuesta = await crearCursos('/cursos/crear', formData);
    ...
    const toggleEstado = async (id, estado) => {
        ...
        const respuesta = await actualizarEstadoCursos('/cursos/actualizarestadocur', parametros);
        const dato = await respuesta.json();
